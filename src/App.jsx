    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <footer className="bg-slate-50 border-t border-slate-100 px-6 py-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="text-[10px] font-black text-slate-900 tracking-[0.2em] uppercase text-center md:text-right">Addis Ababa SCIENCE & TECHNOLOGY University// Integrated  enginnering team project </div>
        </div>
      </footer>
    </div>
  );
